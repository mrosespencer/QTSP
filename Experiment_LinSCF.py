...
for n in range(minsize, maxsize, 5):
    ...
    # We choose to add the quadratic cost associated with a single edge to the linear cost so that the diagonals are 0
        ...
        # MTZ Formulation
        obj[0, n / 5 - 1 + t], time[0, n / 5 - 1 + t], x, gap[0, n / 5 - 1 + t], status[0, n / 5 - 1 + t] = QuadSCF.SolveTSP(n, c, q2, name)
        tour[0, n / 5 - 1 + t], full[0, n / 5 - 1 + t] = VerifyTour.check(x, n)

        # Binary replacement
        obj[1, n / 5 - 1 + t], time[1, n / 5 - 1 + t], x, gap[1, n / 5 - 1 + t], status[1, n / 5 - 1 + t] = LinSCF.SCFLinBI.SolveTSP(n, c, q2, name)
        tour[1, n / 5 - 1 + t], full[1, n / 5 - 1 + t] = VerifyTour.check(x, n)

        # Classic
        obj[2, n / 5 - 1 + t], time[2, n / 5 - 1 + t], x, gap[2, n / 5 - 1 + t], status[2, n / 5 - 1 + t] = LinSCF.SCFLinCL.SolveTSP(n, c, q2, name)
        tour[2, n / 5 - 1 + t], full[2, n / 5 - 1 + t] = VerifyTour.check(x, n)

        # McCormick Envelopes
        obj[3, n / 5 - 1 + t], time[3, n / 5 - 1 + t], x, gap[3, n / 5 - 1 + t], status[3, n / 5 - 1 + t] = LinSCF.SCFLinMcC.SolveTSP(n, c, q2, name)
        tour[3, n / 5 - 1 + t], full[3, n / 5 - 1 + t] = VerifyTour.check(x, n)
        
        # Base 2 Formulation
        obj[4, n / 5 - 1 + t], time[4, n / 5 - 1 + t], x, gap[4, n / 5 - 1 + t], status[4, n / 5 - 1 + t] = LinSCF.SCFLinB2.SolveTSP(n, c, q2, name)
        tour[4, n / 5 - 1 + t], full[4, n / 5 - 1 + t] = VerifyTour.check(x, n)

        # Base 10 Formulation
        obj[5, n / 5 - 1 + t], time[5, n / 5 - 1 + t], x, gap[5, n / 5 - 1 + t], status[5, n / 5 - 1 + t] = LinSCF.SCFLinB10.SolveTSP(n, c, q2, name)
