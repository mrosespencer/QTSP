...
for p in range(8):
    ...
    for n in range(minsize, maxsize, 5):
        ...
        for t in range(trials):
            ...
            # Original Q
            obj[0,int(n / 5 - 1 + t)], time[0,int(n / 5 - 1 + t)], x, gap[0,int(n / 5 - 1 + t)], status[0,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, c, q, name, adj, presolve)
            tour[0,int(n / 5 - 1 + t)], full[0,int(n / 5 - 1 + t)] = VerifyTour.check(x, n)

            # Symmetric Q
            name = qname + "-" + str(1)
            q1 = QMod.half(q, e)
            obj[1,int(n / 5 - 1 + t)], time[1,int(n / 5 - 1 + t)], x, gap[1,int(n / 5 - 1 + t)], status[1,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, c, q1, name, adj, presolve)
            ...
            obj[2,int(n / 5 - 1 + t)], time[2,int(n / 5 - 1 + t)], x, gap[2,int(n / 5 - 1 + t)], status[2,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, c, q2, name, adj, presolve)
            tour[2,int(n / 5 - 1 + t)], full[2,int(n / 5 - 1 + t)] = VerifyTour.check(x, n)

            # Make Q positive semi-definite
            name = qname + "-" + str(3)
            q3 = QMod.plusm(q, e, m)
            obj[3,int(n / 5 - 1 + t)], time[3,int(n / 5 - 1 + t)], x, gap[3,int(n / 5 - 1 + t)], status[3,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, c, q3, name, adj, presolve)
            ...
            obj[4,int(n / 5 - 1 + t)], time[4,int(n / 5 - 1 + t)], x, gap[4,int(n / 5 - 1 + t)], status[4,int(n / 5 - 1 + t)]  = QuadMTZ.SolveTSP(n, c, q4, name, adj, presolve)
            ...
            obj[5,int(n / 5 - 1 + t)], time[5,int(n / 5 - 1 + t)], x, gap[5,int(n / 5 - 1 + t)], status[5,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, cr, qr, name, adj, presolve)
            tour[5,int(n / 5 - 1 + t)], full[5,int(n / 5 - 1 + t)] = VerifyTour.check(x, n)

            # Make QR into symmetric matrix
            name = qname + "-" + str(6)
            q6 = QMod.half(qr, e)
            obj[6,int(n / 5 - 1 + t)], time[6,int(n / 5 - 1 + t)], x, gap[6,int(n / 5 - 1 + t)], status[6,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, cr, q6, name, adj, presolve)
            ...
            obj[7,int(n / 5 - 1 + t)], time[7,int(n / 5 - 1 + t)], x, gap[7,int(n / 5 - 1 + t)], status[7,int(n / 5 - 1 + t)] = QuadMTZ.SolveTSP(n, cr, q7, name, adj, presolve)
